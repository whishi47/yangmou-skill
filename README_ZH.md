...
<p align="center">
  <a href="./README.md">双语版</a> · <a href="./README_EN.md">English</a> · <a href="#30-秒开始">30 秒开始</a> · <a href="#怎么使用">怎么使用</a>
</p>
...
<p align="center">
  <a href="https://whishi47.github.io/yangmou-skill/">打开在线案例图谱</a> ·
  <a href="https://whishi47.github.io/yangmou-skill/gallery.html">浏览案例画廊</a> ·
  <a href="https://whishi47.github.io/yangmou-skill/flows.html">查看用户流程图</a>
</p>
...
该仓库自带一个可直接部署到 GitHub Pages 的静态案例站，目录为 `docs/`：

- `docs/index.html`：主页，展示案例统计、三支柱与七领域入口。
...
- `docs/assets/cases.json`：由 `scripts/build_docs.py` 从 `references/cases.json` 生成。
...
然后打开 `http://localhost:8080/`。GitHub Pages 可将发布目录设为 `docs/`。
