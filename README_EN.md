...
<p align="center">
  <a href="./README_ZH.md">中文</a> · <a href="./README.md">Bilingual</a> · <a href="#start-in-30-seconds">Start in 30 seconds</a> · <a href="#how-to-use-it">How to use it</a>
</p>
...
The repository includes a static case atlas in `docs/` that can be deployed to GitHub Pages:

- `docs/index.html` — home page with case stats, three pillars, and seven domain entries.
- `docs/gallery.html` — visual 88-case gallery with domain, pillar, classic, and type browsing, expandable details, and `#caseId` deep links.
- `docs/flows.html` — four simulated user workflows for sales pricing, cross-team delivery, member retention, and workplace recognition.
- `docs/assets/cases.json` — generated from `references/cases.json` by `scripts/build_docs.py`.
...
Then open `http://localhost:8080/`. For GitHub Pages, set the publishing directory to `docs/`.
...
docs/                    Static case atlas (home + gallery + user flows)
```
